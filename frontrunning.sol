...
// our smart contract can be vulnerable to attack even when it has 0  bugs this can happen because of frontrunning


// The below code is vulnerable to frontrunning
...
contract frontrunning
{
   ...
   function solve (string memory solution) public
   {
      ...
      require(hash == keccak256(abi.encodePacked(solution)),"didnot match");
